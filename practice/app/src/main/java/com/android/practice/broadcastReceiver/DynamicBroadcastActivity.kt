...
import com.android.practice.databinding.ActivityDynamicBroadcastBinding

private const val TAG = "DynamicBroadcastActivity_practice"
class DynamicBroadcastActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDynamicBroadcastBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= ActivityDynamicBroadcastBinding.inflate(layoutInflater)
